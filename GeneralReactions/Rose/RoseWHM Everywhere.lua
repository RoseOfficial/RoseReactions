			...
			conditions = 
			{
				...
				
				{
					data = 
					{
						...
						clusterRange = 30,
						comparator = 1,
						conditionLua = "return RoseCore.Settings.WhmEvHotbar.Sprint.bool",
						conditionType = 1,
						conditions = 
						{
						},
			...
			conditions = 
			{
				...
				
				{
					data = 
					{
						...
						clusterRange = 30,
						comparator = 2,
						conditionLua = "local target = EntityList:Get(eventArgs.detectionTargetID)\n\nif not target then return false end\n\nif target.HP.percent >= 21 then return false end\n\nif target.HP.percent == 0 then return false end\n\nif target.HP.percent <= 20 then return true end\n\nreturn false",
						conditionType = 2,
						conditions = 
						{
						},
